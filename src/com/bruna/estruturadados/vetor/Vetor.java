...
public class Vetor {
	...
	//adiciona elemento no final do vetor - opção 1 - não é muito funcional quando existem muitos elementos no vetor e nem para adicionar um elemento na ultima posição do vetor
	 /*public void adiciona(String elemento){
		for (int i=0;i<this.elementos.length; i++){
			if (this.elementos[i] ==null){
				this.elementos[i] = elemento;
	            break; //utilizado para parar de executar quando encontrar uma posição nula
	        }
	    }
	}*/
	//adiciona elemento no final do vetor - opção 2
	...
	//obtem elementos de uma posição
	 ...
	 //busca sequencial utilizando booleano para retornar true ou false para retornar se o elemento existe ou não no vetor
	...
	//busca sequencial dentro de um vetor retornando a posição do elemento
	 public int busca(String elemento) { // Utilizou esse método por ser mais elegante, pois retorna o número da posição do elemento
		 for (int i=0; i<this.tamanho; i++) {
			 if (this.elementos[i].equals(elemento)) {
	...
	public void remove(int posicao) {
	 ...
	 //verifica tamanho(quantidade de elementos do vetor)
		...
		public String toString() {			
			...
			//concatenação de strings - modo mais simples porém mais demorado para escrever
			/*String s = "[";
